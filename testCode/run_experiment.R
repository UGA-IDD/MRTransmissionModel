...
# set working dir
getwd()
setwd("C:/Users/lhoskovec/Documents/Repos/MRTransmissionModel")
...
# compile C code
# RUN "R CMD SHLIB src/MRModel-funcs.c" in terminal
dyn.load("./src/MRModel-funcs.dll")

# source R code
miceadds::source.all(path = paste0(getwd(),"/R"))
miceadds::source.all(path = paste0(getwd(),"/source"))
