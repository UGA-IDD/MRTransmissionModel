...
#' Function nested inside getDemography.wpp2024() to only pull pop and age.structure
...
#' @export
#'
getDemography.wpp2024.mini <- function(uncode=NA, age.classes=c(1:101),
  ...
  #UNPD data
  data("pop", package = "wpp2024", envir = environment()) # wpp2024
  ...
  data("pop1dt", package = "wpp2024", envir = environment())
  data("popproj1dt", package = "wpp2024", envir = environment())
