...
#' No differences from wpp2024 except updated package
#'
...
#' @export
getDemography.wpp2024 <- function(uncode=NA, age.classes=c(1:101),
                                  if.missing.use.region=F){

  # Get cc (modified uncode), Population Total, and Population Age Structure
  tmp <- getDemography.wpp2024.mini(uncode, age.classes, if.missing.use.region)
  cc <- tmp$cc
  time <- tmp$time
  ...
  data("popAge1dt", package = "wpp2024", envir = environment())
  data("popprojAge1dt", package = "wpp2024", envir = environment())
  ...
  #TFR over time
  data("tfr1dt", package = "wpp2024", envir = environment())
  data("tfrproj1dt", package = "wpp2024", envir = environment())
  ...
  #ASFR overtime
  data("percentASFR1dt", package = "wpp2024", envir = environment())
  ...
  #Births over time
  data("misc1dt", package = "wpp2024", envir = environment())
  data("miscproj1dt", package = "wpp2024", envir = environment())
  ...
  data("mx1dt", package = "wpp2024", envir = environment())
  ...
  data("e01dt", package = "wpp2024", envir = environment())
  data("e0proj1dt", package = "wpp2024", envir = environment())
